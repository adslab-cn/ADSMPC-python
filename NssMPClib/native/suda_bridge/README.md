...
After that, Python can use:

```python
from NssMPC.application.rag.pisces import SudaNativeBridgeBackend, suda_pir_to_share
result = suda_pir_to_share(indicators, database, backend=SudaNativeBridgeBackend())
```
